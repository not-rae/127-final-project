...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $recentViolationDate = isset($_POST["recentViolationDate"]) ? trim($_POST["recentViolationDate"]) : '';
    ...
    <form action="editHistory.php" method="POST">
        <div class="flex-container">
            ...
            <div>
                ...
                <input type="date" id="recentViolationDate" name="recentViolationDate" required>
            </div>
            <div>
